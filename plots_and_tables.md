...
library(knitr)
```
We also need the package <tt>mvtnorm</tt> to be installed, since we use the function  <tt>mvtnorm::pmvnorm</tt>.


We also make use of a custom function to load <tt>.Rdata</tt> data object in named list. The function is taken from  [stackoverflow](https://stackoverflow.com/questions/14757668/combine-multiple-rdata-files-containing-objects-with-the-same-name-into-one-sin)
...
Following code produces Figure 2 in Section 6 of the paper displayed below
...
|:--------------|:--------------|:------------|:------------|:------------|:------------|
|MMM g = 1      |MMM g = 1      |0.025(0.040) |0.023(0.032) |0.037(0.045) |0.037(0.045) |
|MMM g = 2      |MMM g = 2      |0.029(0.042) |0.023(0.036) |0.030(0.044) |0.030(0.044) |
|mixedMem g = 1 |mixedMem g = 1 |0.034(0.051) |0.043(0.050) |0.043(0.049) |0.043(0.049) |
|mixedMem g = 2 |mixedMem g = 2 |0.040(0.054) |0.033(0.047) |0.031(0.042) |0.031(0.042) |
...
### Mixed profiles
We can obtain the elements of Table 2 in Section 6 of the paper with the following code
